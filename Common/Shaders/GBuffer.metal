...
//  Highlands-iOS
//
//  Created by Scott Mehus on 1/31/20.
...
vertex CompositionOut compositionVert(constant float2 *quadVertices [[buffer(0)]],
...
fragment float4 compositionFrag(CompositionOut in [[stage_in]],
